...
logging.getLogger('XTBApi.api').setLevel(logging.ERROR)
LOGIN_TIMEOUT = 120
...
class Client(BaseClient):
    ...
    def open_trade(self, mode, symbol, volume, sl=0, tp=0):
        ...
        response = self.trade_transaction(symbol, mode, 0, volume, price=price, sl, tp)
        self.update_trades()
